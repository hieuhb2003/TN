...
def main():
    ...
    for query in queries:
        ...
        rerank_docs =  rerank_chunks(query, docs, reranker_model, reranker_tokenizer)

        model_results["BGE-M3"][query] = docs[:10]
        model_results['BGE-M3 + Rerank'][query] = rerank_docs[:10]

        output_file = "/home/hungpv/projects/TN/LIGHTRAG/result_26_3/retrieval_results_bge_new.json"
