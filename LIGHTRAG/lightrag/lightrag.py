...
#### new_func
    ...
    def _create_guided_entity_extraction_prompt(self, content: str, original_entities: list[str], original_relations: list) -> str:
        ...
        number_of_entities = len(original_entities)
        ...
        relations_formatted = "\n".join(relations_text)
        number_of_relations = len(original_relations)
        ...
        Original entites has {number_of_entities} entities. Do not change the number of entities. 
        Original relations has {number_of_relations} relations. Do not change the number of relations. 
        """
